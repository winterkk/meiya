<ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            ...
            <li data-name="component" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                ...
                <dd data-name="laydate"> 
                  <a href="javascript:;">日期时间<span class="layui-nav-more"></span></a>
                  <dl class="layui-nav-child">  
                    <dd data-name="demo1"> 
                ...
                <dd data-name="table"> 
                  <a href="javascript:;">数据表格<span class="layui-nav-more"></span></a>
                  <dl class="layui-nav-child">  
                    <dd data-name="simple"> 
                ...
                <dd data-name="laypage"> 
                  <a href="javascript:;">分页<span class="layui-nav-more"></span></a>  
                  <dl class="layui-nav-child">  
                    <dd data-name="demo1"> 
                ...
                <dd data-name="upload"> 
                  <a href="javascript:;">上传<span class="layui-nav-more"></span></a>  
                  <dl class="layui-nav-child">  
                    <dd data-name="demo1"> 
          ...
          <span class="layui-nav-bar" style="top: 270px; height: 0px; opacity: 0;"></span></ul>